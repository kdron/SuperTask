 ...
 */
public class SuggestionFragment extends Fragment implements CardStack.CardEventListener, View.OnClickListener {
    ...
    public void setCardStack() {
        ...
        if (cursor.getCount() > 0) {
            ...
            btnShow.setText("No cloth collection  found");
        }
        }
    ...
    public void discarded(int mIndex, int direction) {
        ...
        if (direction == 1 || direction == 3) {
            ...
            constantClass.bookmarkCloth(mCardAdapter.getItem(mIndex-1).toString(), "1");
